                ...
                <div class="tab-control" data-role="tab-control">
                    ...
                    <div class="frames">
                        <div class="frame" id="_page_1">
                            ...
                            <td bgcolor="#FDFDFD">
                                    <a class="button image-button primary image-left" name="buscarPaciente" href="buscarpacienteficha.php"><i class="icon-search on-left" style="top: -3px; left: 7px"></i>Buscar</a>
                                </td> 
                            </tr></table>
                        	<br />
                            <center>
