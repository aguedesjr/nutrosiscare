                    ...
                    <div class="frames">
                        <div class="frame" id="_page_1">
                            ...
                            <div class="input-control text" data-role="input-control">
                                ...
                                <input type="hidden" id="opbd" name="opbd" value="atualizar"> <!-- Envia qual ação o BD irá realizar -->
                            </div>
                            <table><tr>
                            <td bgcolor="#FDFDFD">
                        ...
                        <div class="frame" id="_page_3">
                            ...
                            <td bgcolor="#FDFDFD">
                                <label>Glicose</label>
                                <div class="input-control text size3" data-role="input-control">
                                <input type="text" id="glicose" name="glicose" value="<? echo utf8_encode($resultficha[22]); ?>" placeholder="Glicose">
                            </div>
                            </td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td>
                            <td bgcolor="#FDFDFD">
                                <label>HB Glicosada</label>
                                <div class="input-control text size3" data-role="input-control">
                                <input type="text" id="hbglicosada" name="hbglicosada" value="<? echo utf8_encode($resultficha[23]); ?>" placeholder="HB Glicosada">
                            </div>
                            </td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td>
                            </tr>
                            </table>
                            ...
                            <td bgcolor="#FDFDFD">
                                <label>VCM</label>
                                <div class="input-control text size3" data-role="input-control">
                                <input type="text" id="vcm" name="vcm" value="<? echo utf8_encode($resultficha[24]); ?>" placeholder="VCM">
                            </div>
                            </td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td>
                            <td bgcolor="#FDFDFD">
                                <label>Uréia</label>
                                <div class="input-control text size3" data-role="input-control">
                                <input type="text" id="ureia" name="ureia" value="<? echo utf8_encode($resultficha[25]); ?>" placeholder="Uréia">
                            </div>
                            </td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td>
                            </tr>
                            </table>
                            ...
                            <td bgcolor="#FDFDFD">
                                <label>TGO</label>
                                <div class="input-control text size3" data-role="input-control">
                                <input type="text" id="tgo" name="tgo" value="<? echo utf8_encode($resultficha[26]); ?>" placeholder="TGO">
                            </div>
                            </td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td>
                            <td bgcolor="#FDFDFD">
                                <label>TGP</label>
                                <div class="input-control text size3" data-role="input-control">
                                <input type="text" id="tgp" name="tgp" value="<? echo utf8_encode($resultficha[27]); ?>" placeholder="TGP">
                            </div>
                            </td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td>
                            </tr>
                            </table>
                            ...
                            <td bgcolor="#FDFDFD">
                                <label>CPK</label>
                                <div class="input-control text size3" data-role="input-control">
                                <input type="text" id="cpk" name="cpk" value="<? echo utf8_encode($resultficha[28]); ?>" placeholder="CPK">
                            </div>
                            </td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td>
                            <td bgcolor="#FDFDFD">
                                <label>Sódio</label>
                                <div class="input-control text size3" data-role="input-control">
                                <input type="text" id="sodio" name="sodio" value="<? echo utf8_encode($resultficha[29]); ?>" placeholder="Sódio">
                            </div>
                            </td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td>
                            </tr>
                            </table>
                            ...
                            <td bgcolor="#FDFDFD">
                                ...
                                <div class="input-control text size3" data-role="input-control">
                                <input type="text" id="potassio" name="potassio" value="<? echo utf8_encode($resultficha[30]); ?>" placeholder="Potássio">
                            </div>
                            </td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td>
                            <td bgcolor="#FDFDFD">
                                <label>Cálcio</label>
                                <div class="input-control text size3" data-role="input-control">
                                <input type="text" id="calcio" name="calcio" value="<? echo utf8_encode($resultficha[31]); ?>" placeholder="Cálcio">
                            </div>
                            </td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td><td bgcolor="#FDFDFD"></td>
                            </tr>
                            </table>
                        ...
                        <div class="frame" id="_page_4">
                            ...
                            <div class="input-control textarea" data-role="input-control">
                                <textarea name="cafeusual" placeholder="Café da Manhã"><? echo utf8_encode($resultficha[42]); ?></textarea>
                            </div>
                            
                            <label>Colação</label>
                            <div class="input-control textarea" data-role="input-control">
                                <textarea name="colacaousual" placeholder="Colação"><? echo utf8_encode($resultficha[43]); ?></textarea>
                            </div>
                            
                            <label>Almoço</label>
                            <div class="input-control textarea" data-role="input-control">
                                <textarea name="almocousual" placeholder="Almoço"><? echo utf8_encode($resultficha[44]); ?></textarea>
                            </div>
                            
                            <label>Lanche</label>
                            <div class="input-control textarea" data-role="input-control">
                                <textarea name="lancheusual" placeholder="Lanche"><? echo utf8_encode($resultficha[45]); ?></textarea>
                            </div>
                            
                            <label>Jantar</label>
                            <div class="input-control textarea" data-role="input-control">
                                <textarea name="jantarusual" placeholder="Jantar"><? echo utf8_encode($resultficha[46]); ?></textarea>
                            </div>
                            
                            <label>Ceia</label>
                            <div class="input-control textarea" data-role="input-control">
                                <textarea name="ceiausual" placeholder="Ceia"><? echo utf8_encode($resultficha[47]); ?></textarea>
                            </div>
